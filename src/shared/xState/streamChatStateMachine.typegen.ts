  ...
  export interface Typegen0 {
        '@@xstate/typegen': true;
        internalEvents: {
          "done.invoke.stream-chat-state.init:invocation[0]": { type: "done.invoke.stream-chat-state.init:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"done.invoke.stream-chat-state.loading:invocation[0]": { type: "done.invoke.stream-chat-state.loading:invocation[0]"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"error.platform.stream-chat-state.loading:invocation[0]": { type: "error.platform.stream-chat-state.loading:invocation[0]"; data: unknown };
